      ...
      <div class="white-box p-4 flex flex-col">
        <div class="mb-1">
          <Show
            ...
            fallback={
              <p>{character().subclasses[character().main_class] ? `${classes()[character().main_class]} - ${translate(dnd2024Config.classes[character().main_class].subclasses, locale())[character().subclasses[character().main_class]]}` : classes()[character().main_class]}</p>
            }
          >

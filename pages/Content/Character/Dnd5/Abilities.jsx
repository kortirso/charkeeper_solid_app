...
import { ErrorWrapper, Checkbox, Button, Levelbox } from '../../../../components';
      ...
      <For each={Object.entries(dict().dnd.abilities)}>
        {([slug, ability]) =>
          <div class="blockable p-4 mb-2">
            <p class="uppercase text-center mb-4 dark:text-snow">{ability}</p>
            <div class="flex">
              <div class="mr-4">
              ...
              <div class="flex-1">
                <div class="flex justify-end items-center mb-2 dark:text-snow">
                ...
                <For each={(editMode() ? skillsData() : character().skills).filter((item) => item.ability === slug)}>
                  {(skill) =>
                    <div class="flex justify-end items-center mb-1">
                      <p class={`flex items-center dark:text-snow ${skill.selected ? '' : 'font-cascadia-light'}`}>

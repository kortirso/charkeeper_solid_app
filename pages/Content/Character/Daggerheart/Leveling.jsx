              ...
              {([classSlug, classData]) =>
                <div class="mb-2">
                  <Show
                    ...
                    fallback={
                      <p class="dark:text-snow">{character().subclasses[character().main_class] ? `${classes()[character().main_class].name[locale()]} - ${classes()[character().main_class].subclasses[character().subclasses[character().main_class]].name[locale()]}` : classes()[character().main_class].name[locale()]}</p>
                    }
                  >
                    <Checkbox

    ...
    <>
      <Switch>
        ...
        <Match when={currentTab() === 'campaigns'}>
          ...
          <CharacterNavigation
            tabsList={['allFilter'].concat(['dnd5', 'dnd2024', 'pathfinder2', 'daggerheart', 'dc20', 'fallout', 'cosmere', 'fate'].filter((item) => campaignProviders().includes(item)))}
          ...
          <div class="p-4 flex-1 flex flex-col overflow-y-auto">
            <div class="flex-1">
              <Select
                ...
                items={{ 'dnd5': 'D&D 5', 'dnd2024': 'D&D 2024', 'daggerheart': 'Daggerheart', 'pathfinder2': 'Pathfinder 2', 'fate': 'Fate', 'fallout': 'Fallout 2D20', 'cosmere': 'Cosmere', 'dc20': 'DC20' }}

  ...
  >
    <Switch>
      ...
      <Match when={props.size === 5}>
        <path d="M 50 25 L 85 45 L 85 75 L 50 55 L 15 75 L 15 45 Z" fill="currentColor" />
      </Match>
      <Match when={props.size === 6}>
        <path d="M 50 20 L 85 40 L 85 70 L 50 50 L 15 70 L 15 40 Z" fill="currentColor" />
        <path d="M 50 55 L 85 75 L 85 85 L 50 65 L 15 85 L 15 75 Z" fill="currentColor" />
      </Match>
    </Switch>
  </svg>
